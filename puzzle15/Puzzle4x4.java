...
public class Puzzle4x4 implements ActionListener {
    JFrame fr;
    JPanel mainPanel;
    JPanel buttonPanel;
    JButton[][] button;
...
public void actionPerformed(ActionEvent ae) {
    if (ae.getSource() == solveButton) {
        SolveWorker worker = new SolveWorker(board, this); // Sử dụng new SolveWorker(board, this)
        worker.execute();
        ...
        if (!flag) {
            ...
            if (board[r][c] != -1) {
                if (r + 1 < rows && board[r + 1][c] == -1) {
                    ...
                    String fileName = "./puzzle15/Pic/" + board[r][c] + ".png";
